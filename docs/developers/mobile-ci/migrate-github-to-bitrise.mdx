...
sidebar_position: 2
sidebar_label: "Migrate to Bitrise"
---
...
<Steps>
  <Step title="Create a pipeline in Immerse">
    ...
    <VideoLoop src="/videos/07-creating-pipelines.mp4" loop caption="Creating a new pipeline in Immerse — select your platform type and provide your ASK ID" maxLoops={4} />
