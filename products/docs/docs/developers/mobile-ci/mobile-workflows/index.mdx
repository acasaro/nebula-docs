...
sidebar_position: 1
sidebar_label: "Enterprise Pipelines"
---
...
<Frame caption='The Create Pipeline page in Immerse showing available project types'>
  ![create-pipeline-types](/images/image-place-holder.png)
</Frame>
...
<Steps>
  ...
  <Step title="Click Create and select Mobile">
    ...
    <Frame caption="Selecting the Mobile pipeline type">
      ![select-mobile-pipeline](/images/image-place-holder.png)
    </Frame>
  ...
  <Step title="Configure inputs">
    ...
    <Frame caption="The Create Pipeline form with ASK ID, repository URL, pipeline name, and JFrog inputs">
      ![create-pipeline-form](/images/image-place-holder.png)
    </Frame>
...
<Frame caption='Pipeline creation flow — checking for existing Bitrise projects and provisioning as needed'>
  ![pipeline-creation-flow](/images/image-place-holder.png)
</Frame>
