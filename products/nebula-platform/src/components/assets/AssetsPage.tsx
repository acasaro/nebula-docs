...
import { formatBytes, useAssetDelete, useAssetUpload, useAssets, type Asset } from "@/lib/assets";
...
import { AssetToolbar, type AssetCategoryFilter, type AssetSort } from "./AssetToolbar";
...
function applyFilter(assets: Asset[], filter: AssetCategoryFilter, search: string): Asset[] {
