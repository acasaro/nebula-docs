...
/**
 * Side-anchored drawer, built on Radix Dialog. Use this instead of
 * `Dialog` when the editing surface is too dense for a centered modal —
 * e.g. a multi-tab form. Anchors to `right` by default.
 */
...
const SHEET_SIDE: Record<Side, string> = {
  right:
