      ...
      {!installUrl ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set <code>GITHUB_APP_INSTALL_URL</code> in <code>products/nebula/.env</code>{' '}
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (confirm(`Remove ${it.account.login} from Nebula? This does not uninstall the app on GitHub.`)) {
