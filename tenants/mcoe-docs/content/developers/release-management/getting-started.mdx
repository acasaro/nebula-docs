...
---
import { BitrisePrereq } from "@tenant/components/BitrisePrereq";
import { StageStatus } from "@tenant/components/StageStatus";
import { PlatformNav } from "@tenant/components/PlatformNav";
...
<BitrisePrereq feature="Rollouts" />
...
<StageStatus stages={[
{ name: "Release Candidate", status: "completed", label: "Select build" },
{ name: "Testing", status: "completed", label: "TestFlight / Google Play" },
{ name: "Approvals", status: "active", label: "Team sign-off" },
{ name: "Store Review", status: "upcoming", label: "Apple / Google" },
